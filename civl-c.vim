...
syn match civl_builtin		"$comm_enqueue\|$scope_parent\|$scopeof\|$choose_int\|$wait\|$exit\|$message_pack\|$message_tag\|$message_dest\|$message_size\|$message_unpack\|$gcomm_create\|$comm_create\|$comm_size\|$comm_place\|$comm_enqueue\|$comm_probe\|$comm_seek\|$comm_dequeue\|$assert\|$malloc\|$free"
